//Using Query String we can send small amount of information to the server using the url
// It can be send as Key value pair after ? mark symbol
...
app.get('/api/v1/query', (req, res) => {
    // api/v1/query?name=sachin&age=30
